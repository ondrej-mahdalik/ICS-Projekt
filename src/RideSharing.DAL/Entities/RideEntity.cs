...
{
    public record RideEntity(Guid Id, string FromName, double FromLatitude, double FromLongitude, int Distance, string ToName, double ToLatitude, double ToLongitude, DateTime Departure, DateTime Arrival, Guid VehicleId, string? Note) : IEntity
    {
