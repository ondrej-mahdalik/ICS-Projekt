...
public static class UserSeeds
{
    ...
    public static readonly UserEntity UserUpdate = GetNoRelationsEntity(DriverUser) with { Id = Guid.Parse("BD566AB0-FE85-4E3A-B773-9AC69BCFA3EF")};
    public static readonly UserEntity UserDelete = GetNoRelationsEntity(DriverUser) with { Id = Guid.Parse("1A3431A4-C848-4C73-91FD-4D6835A19D23")};
    
    public static readonly UserEntity CascadeDeleteUser = GetNoRelationsEntity(DriverUser) with { Id = Guid.Parse("f8d62aa5-d373-4ece-8b9f-989e3f2acaf2") };
    public static readonly UserEntity VehicleTestsUser = GetNoRelationsEntity(DriverUser) with { Id = Guid.Parse("d71772c9-7d37-4c0d-88aa-f6fcb646bb1d") };
