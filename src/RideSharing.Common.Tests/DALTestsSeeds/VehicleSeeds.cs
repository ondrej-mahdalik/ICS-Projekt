...
public static class VehicleSeeds
{
    ...
    public static readonly VehicleEntity Karosa = new(
            ...
            Make: "Karosa",
            Model: "LC 757",
            Registered: DateTime.Parse("03/12/1983", CultureInfo.InvariantCulture),
            Seats: 20,
    ...
    public static readonly VehicleEntity DeleteVehicle = UpdateVehicle with {Id = Guid.Parse("02dc5f5b-dbae-464e-bfa4-44d7e87b6ae9")};
